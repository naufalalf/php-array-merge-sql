...
echo "<table style='width: 100%'>";
         echo "<table class='table table-striped table-bordered' id='myTable' style='width:80%; font-size:20px;' align='center'>";
             ...
             echo "<center><h3>Toko : Toeng Market Cyber Malang</h3></center>";
             echo "<thead>";
...
//CurrentRow.Item("Product_ID_Toko").ToString
            ...
            $sqlq = mysqli_query($conn3, 
              ...
              WHERE c.method_id='18' AND date(a.createtime)>='2021-05-18' AND date(a.createtime)<='$currdate' AND f.id='11'");
