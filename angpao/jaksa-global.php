...
<?php
 ...
 echo "<table style='width: 100%'>";
         echo "<table class='table table-striped table-bordered' id='myTable' style='width:80%; font-size:20px;' align='center'>";
             ...
             echo "<center><h3>Toko : Toeng Market Jaksa Agung</h3></center>";
             echo "<thead>";
            ...
            $sqlq = mysqli_query($conn2, 
              ...
              WHERE c.method_id='10' AND date(a.createtime)>='2021-02-02' AND date(a.createtime)<='2021-03-31' AND f.id='4'");
