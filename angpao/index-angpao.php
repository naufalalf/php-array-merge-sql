...
<body>
  ...
  <center>
    <h3>REPORT CLAIM VOUCHER ANGPAO OENTOENG</h3>
  <form class="col-5" method="post">
          <select class="col-3 form-control" name="model" id="model" required="" style="height: 30px;width: 115px; font-size: 17px;border-radius: 10px 10px 10px 10px;">
         ...
         if( isset($_POST['submit'])){
          ...
          ?>
           <div class="col-sm-4" style="margin: 0 900px 0 0px;">
            <form class="" action="printexcelth.php" method="POST">
            <table>
              <tr>
