...
include 'koneksi.php';
    ...
    echo "<center><h4>Tanggal : ".$tgl."</h4></center>";
         ...
         echo "<table class='table table-striped table-bordered' id='myTable' style='width:80%;margin-bottom:30px' align='center'>";
          ...
          $tot = mysqli_query($conn, "SELECT date(a.tgl_undian) as tgl, sum(b.nominal) as nomin, a.store as store FROM log_undian_baru as a LEFT JOIN history_tbl_undian as b ON a.id_vocer=b.id where a.store='$store' and date(a.tgl_undian)='$tgl' GROUP BY tgl");
